...
class VisionEncoder(nn.Module):
    ...
    def forward(self, image_input):
        ...
        Converts to PIL image(s) if necessary and returns patch embeddings.
        
        Returns:
            patch_embeddings (torch.Tensor): A tensor of shape (B, n_patches, embed_dim).
        """
        ...
        with torch.no_grad():
            ...
            patch_embeddings = outputs.hidden_states[-1][:, 0:, :]  # Use all tokens (including CLS if desired)
